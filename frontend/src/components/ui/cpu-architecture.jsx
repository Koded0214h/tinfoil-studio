...
@keyframes cpu-orb-move { from { offset-distance: 0% } to { offset-distance: 100% } }
.cpu-line-1 { offset-path: path("M 10 20 h 79.5 q 5 0 5 5 v 24"); animation-name: cpu-orb-move; animation-duration: 2.4s; animation-delay: 0s; }
.cpu-line-2 { offset-path: path("M 180 10 h -69.7 q -5 0 -5 5 v 24"); animation-name: cpu-orb-move; animation-duration: 2.2s; animation-delay: -0.8s; }
.cpu-line-3 { offset-path: path("M 130 20 v 21.8 q 0 5 -5 5 h -10"); animation-name: cpu-orb-move; animation-duration: 1.8s; animation-delay: -0.3s; }
.cpu-line-4 { offset-path: path("M 170 80 v -21.8 q 0 -5 -5 -5 h -50"); animation-name: cpu-orb-move; animation-duration: 2.0s; animation-delay: -1.1s; }
.cpu-line-5 { offset-path: path("M 135 65 h 15 q 5 0 5 5 v 10 q 0 5 -5 5 h -39.8 q -5 0 -5 -5 v -20"); animation-name: cpu-orb-move; animation-duration: 3.2s; animation-delay: -0.5s; }
.cpu-line-6 { offset-path: path("M 94.8 95 v -36"); animation-name: cpu-orb-move; animation-duration: 1.5s; animation-delay: -1.4s; }
.cpu-line-7 { offset-path: path("M 88 88 v -15 q 0 -5 -5 -5 h -10 q -5 0 -5 -5 v -5 q 0 -5 5 -5 h 14"); animation-name: cpu-orb-move; animation-duration: 2.6s; animation-delay: -0.2s; }
.cpu-line-8 { offset-path: path("M 30 30 h 25 q 5 0 5 5 v 6.5 q 0 5 5 5 h 20"); animation-name: cpu-orb-move; animation-duration: 1.9s; animation-delay: -0.9s; }
`;
